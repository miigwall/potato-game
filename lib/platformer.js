	...
	checkThisWay: function(colObj) {
		if(colObj.p.thisway) {
			...
			if(this.p.onThisWay == true) {
				Q.audio.play("falling-male.mp3", 5000);
...
var sound_files = "gameplay.mp3, fire.mp3, jump.mp3, jump1.mp3, heart.mp3, hit.mp3, coin.mp3, game-start.mp3, drink.mp3, drink2.mp3, drink3.mp3, enemy-die.mp3, falling-male.mp3, ";
