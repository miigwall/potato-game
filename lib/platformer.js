...
Q.loadTMX("level1.tmx, collectables.json, doors.json, enemies.json, fire.mp3, jump.mp3, heart.mp3, hit.mp3, drink.mp3, bgmusic.mp3, player.json, player.png, traps.json, trap1.png", function() {
