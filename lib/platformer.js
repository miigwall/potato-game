...
// Checks if player on exit tile
	checkExit: function(colObj) {
		if(colObj.p.exit) { 
			...
			console.log("Score: " + this.p.score);
			console.log("Strength: " + this.p.strength);
...
Q.scene('hud',function(stage) {
	...
	var label = container.insert(new Q.UI.Text({ x: 200, y: 20, label: "Score: " + Q.PLAYER_POINTS, color: "#000" }));
	container.fit(20);
});
