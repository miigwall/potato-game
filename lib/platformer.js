...
Q.scene('hud',function(stage) {
	...
	var label = container.insert(new Q.UI.Text({ x: 200, y: 20, label: "Drunkness: " + Q.PLAYER_POINTS, color: "#000" }));
	container.fit(20);
});

// Loads everything for ready to use
Q.loadTMX("level1.tmx, level2.tmx, collectables.json, doors.json, enemies.json, fire.mp3, jump.mp3, heart.mp3, hit.mp3, coin.mp3, player.json, player.png", function() {
