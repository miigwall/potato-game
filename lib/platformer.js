...
// Level change limits
			switch(next_level) {
				case 2:
					level_change_limit = 55; // Cant go to level 2 if drunkess lower than value
					break;
				default:
					return;
			}
...
Q.loadTMX("level1.tmx, level2.tmx, collectables.json, doors.json, traps.json, enemies.json, bgmusic.mp3, fire.mp3, jump.mp3, heart.mp3, hit.mp3, coin.mp3, drink.mp3, player.json, player.png", function() {
	Q.compileSheets("player.png","player.json");
	Q.compileSheets("collectables.png","collectables.json");
	Q.compileSheets("enemies.png","enemies.json");
	Q.compileSheets("doors.png","doors.json");
	Q.compileSheets("trap1.png","traps.json");
	Q.animations("player", {
